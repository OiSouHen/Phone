...
vRP.prepare("gcphone/getPhoneMessages","SELECT phone_messages.* FROM phone_messages LEFT JOIN summerz_characters ON summerz_characters.id = @identifier WHERE phone_messages.receiver = summerz_characters.phone")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local userPhones = {}
